...
export class AssessmentsController {
  ...
  async findOne(
    ...
    return this.assessmentsService.findOne(id, userId, user.role || UserRole.USER);
  }
  ...
  async update(
    ...
    return this.assessmentsService.update(id, updateDto, userId, user.role || UserRole.USER);
  }
}
