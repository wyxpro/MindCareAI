...
>(({ className, children, ...props }, ref) => {
  ...
  const shouldInjectDescription =
    !hasDescription && ariaDescribedbyProp === undefined;
  const ariaDescribedby =
    ariaDescribedbyProp ?? (shouldInjectDescription ? descriptionId : undefined);
