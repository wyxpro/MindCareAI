    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                ...
                'glow-lg': '0 0 30px hsla(var(--primary) / 0.4)',
                'success-glow': '0 0 20px hsla(var(--success) / 0.3)',
                'card-hover': '0 10px 30px hsla(var(--foreground) / 0.1)',
                'inner-glow': 'inset 0 0 20px hsla(var(--primary) / 0.1)'
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
